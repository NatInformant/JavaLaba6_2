...
import JavaLaba6.Model.FileSystemElement;
...
public class FileSystemElementsService {
    ...
    private static void GetFileSystemElement(File fileSystemElement) {
        if (fileSystemElement.isFile()) {
            ...
            fileSystemElementsInCurrentDir.add(new JavaLaba6.Model.File(
                    currentFileName,
            ...
            fileSystemElementsInCurrentDir.add(new JavaLaba6.Model.Directory(
                    currentDirName,
